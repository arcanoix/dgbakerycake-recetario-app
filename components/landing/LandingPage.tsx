...
export const LandingPage = () => {
  ...
  return (
    <div className={`min-h-screen bg-white ${playfair.variable} ${dmSans.variable}`} style={{ fontFamily: 'var(--font-dm-sans)' }}>
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <Link href="/" className="flex items-center gap-3">
              ...
              <span className="text-2xl font-bold bg-gradient-to-r from-amber-700 to-orange-600 bg-clip-text text-transparent" style={{ fontFamily: 'var(--font-playfair)' }}>
                DGcost
              </span>
              <span className="bg-gradient-to-r from-amber-600 to-orange-600 text-white text-xs font-semibold px-2.5 py-1 rounded-full shadow-sm">
                BETA
              </span>
            </Link>
            <div className="flex items-center gap-4">
              <Link href="/auth/login" className="text-gray-700 hover:text-amber-700 font-medium transition-colors">
                Iniciar sesión
              </Link>
              <Link href="/auth/register">
                <Button className="bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 shadow-lg shadow-amber-200/50 transition-all">
                  Comenzar gratis
                </Button>
              </Link>
            </div>
        ...
        <div className="container mx-auto relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <motion.p
              ...
              className="text-xl md:text-2xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed font-normal"
            >
            ...
            >
              <Link href="/auth/register">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="h-14 text-lg px-8 bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 shadow-lg shadow-amber-300/50 font-semibold flex items-center justify-center gap-2 text-white"
              ...
              <Link href="/auth/login">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="h-14 text-lg px-8 border-2 border-amber-300 text-amber-700 font-semibold flex items-center justify-center gap-2 hover:border-amber-400 hover:shadow-md transition-all"
            ...
            >
              {[
                ...
                >
                  <div className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-amber-700 to-orange-600 bg-clip-text text-transparent" style={{ fontFamily: 'var(--font-playfair)' }}>
                    {stat.value}
                  </div>
        ...
        <section className="py-20 px-4 bg-gray-100">
          <div className="container mx-auto">
            <div className="max-w-3xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-bold text-center mb-4 text-gray-900" style={{ fontFamily: 'var(--font-playfair)' }}>
              ¿Te suena conocido?
            </h2>
                  ...
                  >
                    <CardContent className="p-8">
                      <motion.div
                        ...
                        className="w-14 h-14 bg-gradient-to-br from-amber-100 to-orange-100 flex items-center justify-center text-2xl mb-6"
                        style={{
      ...
      {/* Mobile App Section */}
      <AnimatedSection>
        <section className="py-20 px-4 bg-gradient-to-br from-amber-50 to-orange-50/30">
          <div className="container mx-auto max-w-4xl">
            <div className="text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900" style={{ fontFamily: 'var(--font-playfair)' }}>
                App Móvil en Camino
              </h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <div 
                  className="flex items-center gap-3 bg-white px-6 py-4 shadow-lg"
                  ...
                  >
                    <CardContent className="p-8">
                      ...
                      <div className="flex items-baseline gap-2">
                        <span className="text-3xl font-bold bg-gradient-to-r from-amber-700 to-orange-600 bg-clip-text text-transparent" style={{ fontFamily: 'var(--font-playfair)' }}>
                          {testimonial.metric}
                        </span>
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto">
            <motion.div
              ...
              className="max-w-3xl mx-auto text-center bg-gradient-to-br from-amber-600 to-orange-600 p-12 text-white shadow-2xl shadow-amber-300/30"
              style={{
            ...
            >
              ...
              <Link href="/auth/register">
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="text-lg px-8 py-6 bg-white text-amber-700 font-bold shadow-lg hover:shadow-xl transition-shadow"
                  style={{
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex gap-4">
              <a href="#" className="text-gray-400 hover:text-amber-400 text-2xl transition-colors" aria-label="Facebook">📘</a>

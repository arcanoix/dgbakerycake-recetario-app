...
export async function updateSession(request: NextRequest) {
  ...
  // No redirigir al dashboard si el usuario está en la página de reset-password o en /blog,
  // ya que /blog es una ruta pública accesible para todos.
  if (user && isPublicPath && !pathname.startsWith('/auth/reset-password') && pathname !== '/' && !pathname.startsWith('/blog')) {
